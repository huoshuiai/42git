...
def init_data():
    ...
    data = load_csv('data-7000-20240710') # TODO: load data
    payloads = []
    documents = []
    ids = []
    for _, row in data.iterrows():
        ...
        name = row['name']
        link = row['html_url']
        documents.append(row['llm_conclusion'])
...
優化器有分為 h nsw_config 和 quantization_config
